...
class Twm_Application_Module_Bootstrap extends Zend_Application_Module_Bootstrap {
	...
	protected function _initPluginloader() {
		...
		//$path = "$namespace/$module/Resource";
		//$prefix = "{$namespace}_{$module}_Resource";
		//$this->getApplication()->getPluginLoader()->addPrefixPath($prefix, $path);
	}
