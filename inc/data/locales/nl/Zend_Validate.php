...
return array(
    ...
    "A record with the supplied identity could not be found." => "Geen account gevonden met de ingevoerde logingegevens",
    ...
    "'%value%' is more than %max% characters long" => "waarde is meer dan %max% tekens lang",

    // Twm_Validate_PasswordConfirmation
    "Password confirmation does not match" => "De opgegeven wachtwoorden komen niet overeen",

	// Twm_Validate_PasswordStrength
    "Password must be at least 5 characters in length" => "Het wachtwoord moet minimaal 5 karakters lang zijn",
	
	// Twm_Validate_AgreementRequired
	"Agreement required" => "U dient akkoord te gaan met de gebruikersvoorwaarden"
);
